    ...
    <table class="table table-borderless">
      <tr>
        ...
        <td width="90%">
          ...
          <h5>Facturas emitidas del {{\Carbon\Carbon::parse($fecha_inicial)->format('d/m/Y')}} al {{\Carbon\Carbon::parse($fecha_final)->format('d/m/Y')}}</h5>
        </td>
      </tr>
    </table>
</header>
    ...
    <div class="row">
      <div class="col-md-12">
        <table class="table table-sm table-striped text-center">
          <thead>
            <tr>
              <th>No. Corte</th><th>Tipo</th><th>Documento</th>
              <th>Fecha</th><th>Nombre</th><th>Sub total</th>
              <th>Descuento</th><th>Recargo</th><th>Total</th>
              <th>Saldo</th>
            </tr>
          </thead>
          <tbody>
