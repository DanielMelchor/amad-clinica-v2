		...
		<div class="card-header text-center">
			<div class="row">
				...
				<div class="col-md-2" style="text-align: right;">
					...
					<a href="{{ route('rpt_admision_hospitalizacion_pdf',[$fecha_inicial, $fecha_final]) }}" class="btn btn-xs btn-reporte" title="Impresión" target="_blank"><i class="fas fa-file-pdf"></i></a>
					<a href="{{ route('rpt_admision_hospitalizacion_xls',[$fecha_inicial, $fecha_final]) }}" class="btn btn-xs btn-excel" title="Excel"><i class="fas fa-file-excel"></i></a>
				</div>
			</div>
		</div>
		<div class="card-body">
...
@section('js')
	...
	function fn_buscar(){
		...
		var url = "{{ route('rpt_admision_hospitalizacion', ['fecha_inicial' => '2020-01-01', 'fecha_final' => '2020-01-02', 'tipo_admision' => 'T']) }}";
