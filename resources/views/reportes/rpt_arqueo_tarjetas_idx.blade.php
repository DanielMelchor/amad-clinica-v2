		...
		<div class="card-header text-center">
			<div class="row">
				...
				<div class="col-md-2" style="text-align: right;">
					...
					<a href="{{ route('rpt_arqueo_tarjetas_pdf', [$fecha_inicial, $fecha_final]) }}" class="btn btn-xs btn-danger" title="Impresión" target="_blank"><i class="fas fa-file-pdf"></i></a>
					<a href="{{ route('rpt_arqueo_tarjetas_xls', [$fecha_inicial, $fecha_final]) }}" class="btn btn-xs" title="Excel" title="Impresión" style="background-color: #A5C890 !important;"><i class="fas fa-file-excel"></i></a>
				</div>
			</div>
		</div>
		<div class="card-body">
			<div class="table-responsive">
				<table id="tblprincipal" class="table table-sm table-striped text-center">
					<thead>
						<tr>
							<th>Recibo</th><th>Fecha</th><th>Casa</th><th>No. Documento</th><th>No. Autorización</th><th>Monto</th>
						</tr>
					</thead>
					<tbody>
...
@section('js')
	...
	<script>
	  ...
	  function fn_buscar(){
    	...
    	var url = "{{ route('rpt_arqueo_tarjetas', ['fecha_inicial' => '2020-01-01', 'fecha_final' => '2020-01-02', 'tipo_admision' => 'T']) }}";
