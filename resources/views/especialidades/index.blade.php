...
@section('content')
										...
										<tbody>
											@foreach($pEspecialidades as $pEspecialidad)
												<tr class="text-center" style="font-size: 12px;">
													...
													@if($pEspecialidad->estado == 1)
														<td>Alta</td>
													@else
														<td>Baja</td>
													@endif
													<td>
														@php $Id= Crypt::encrypt($pEspecialidad->id); @endphp
	...
	<div class="modal fade" id="agregarModalCenter" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    		<div class="modal-content">
      			<form role="form" id="formaNuevoRegistro" method="POST" action="{{route('especialidad_grabar')}}">
	      			@csrf
	      			<div class="card">
	      					...
	      					<div class="row text-center">
							    <div class="input-group input-group-sm mb-1 col-md-5 offset-md-1">
							  		<div class="input-group-prepend">
								    	<label class="input-group-text w-100">Siglas</label>
								  	</div>
								  	<input type="text" class="form-control" placeholder="Iniciales maximo 5 caracteres" aria-label="Username" aria-describedby="basic-addon1" id="iniciales" name="iniciales" maxlength="5" autofocus required value="{{ old('iniciales')}}" style="text-transform: uppercase;">
								</div>
							</div>
							<div class="row text-center">
								<div class="input-group input-group-sm mb-1 col-md-10 offset-md-1">
							  		<div class="input-group-prepend">
								    	<label class="input-group-text w-100">Descripcion</label>
								  	</div>
	...
	<div class="modal fade" id="editarModalCenter" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="editarModalCenterTitle" aria-hidden="true">
  		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    		<div class="modal-content">
      			<form role="form" method="POST" action="{{route('especialidad_actualizar')}}">
	      			@csrf
	      			<div class="card">
	      				<div class="card-header" style="background-color: #F4F6F7;">
	      					<div class="row">
	      				...
	      				<div class="card-body">
	      					...
	      					<div class="row text-center">
							    <div class="input-group input-group-sm mb-1 col-md-5 offset-md-1">
								  	...
								  	<input type="text" class="form-control" placeholder="Iniciales maximo 5 caracteres" aria-label="Username" aria-describedby="basic-addon1" id="einiciales" name="einiciales" maxlength="5" autofocus required style="text-transform: uppercase;">
								</div>
							</div>
							<div class="row text-center">
								<div class="input-group input-group-sm mb-1 col-md-10 offset-md-1">
								  	...
								  	<input type="text" class="form-control" placeholder="nombre especialidad" aria-label="Username" aria-describedby="basic-addon1" id="edescripcion" name="edescripcion" required>
								</div>
					        </div>
					        <div class="row">
					        	<div class="form-group offset-md-1">
		...
		function fn_edicion(id){
			...
			$.ajax({
	            ...
	            success: function(response){
	            	...
	            	document.getElementById('einiciales').value    = response.iniciales;
