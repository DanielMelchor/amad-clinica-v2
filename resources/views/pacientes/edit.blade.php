...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form role="form" method="POST" action="{{route('actualizar_paciente', $id )}}">
                @csrf
                <div class="card">
                    <div class="card-header" style="background-color: #E1E8ED;">
                        <div class="row">
                            <div class="col-md-9">
                                <h6>Edición de Paciente</h6>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="input-group input-group-sm col-md-6 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="nombres" name="nombres" autofocus required value="{{ $registro->nombres }}" tabindex="10">
                                    </div>
                                    <div class="input-group mb-1 input-group-sm col-md-6">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text">Código</label>
                                        </div>
                                        <input type="number" class="form-control numero" id="codigo_id" name="codigo_id" value="{{ $registro->codigo_id }}" style="text-align: right;" readonly tabindex="16">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-group input-group-sm col-md-6 mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="apellidos" name="apellidos" required value="{{ $registro->apellidos }}" tabindex="11">
                                    </div>
                                    <div class="input-group mb-1 input-group-sm col-md-6">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text">Expediente</label>
                                        </div>
                                        <input type="number" class="form-control form-control-sm numero" id="expediente_no" name="expediente_no" required value="{{ $registro->expediente_no }}" style="text-align: right;" tabindex="17" min="0" step="1" onchange="verificar_expediente(); return false;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-group input-group-sm col-md-6 mb-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="apellido_casada" name="apellido_casada" value="{{ $registro->apellido_casada }}" tabindex="12">
                                    </div>
                                    <div class="input-group mb-1 input-group-sm col-md-6">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text">Expediente Anterior</label>
                                        </div>
                                        <input type="number" class="form-control form-control-sm numero" id="expediente_anterior_no" name="expediente_anterior_no" value="{{ $registro->expediente_anterior_no }}" style="text-align: right;" min="0", step="1" tabindex="18">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-group mb-2 input-group-sm col-md-6">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text">Fecha Nacimiento</label>
                                        </div>
                                        <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" required value="{{ $registro->fecha_nacimiento }}" style="text-align: right;" tabindex="13">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 mb-1">
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="masculino" name="genero" value="M" @if($registro->genero == 'M') checked @endif tabindex="14">
                                                <label for="masculino">&nbsp;Masculino&nbsp;&nbsp;&nbsp;</label>
                                            </div>
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="negativo" name="genero" value="F" @if($registro->genero == 'F') checked @endif tabindex="15">
                                ...
                                <div class="row">
                                    <div class="input-group input-group-sm col-md-12 mb-1">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text">Profesio</label>
                                        </div>
                                        <input type="text" class="form-control" id="profesion" name="profesion" value="{{ $registro->profesion }}" tabindex="29">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-group input-group-sm col-md-12 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="referido_por" name="referido_por" value="{{ $registro->referido_por }}" tabindex="25">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="tab-pane active" id="medico">
                                        ...
                                        <div class="row text-center">
                                            <div class="form-group col-md-10 offset-md-1">
                                                ...
                                                <textarea class="form-control form-control-sm" id="antmedico_descripcion" name="antmedico_descripcion" rows="3">{{ $registro->antmedico_descripcion }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="quirurgico">
                                        ...
                                        <div class="row text-center">
                                            <div class="form-group col-md-10 offset-md-1">
                                                ...
                                                <textarea class="form-control form-control-sm" id="antquirurgico_descripcion" name="antquirurgico_descripcion" rows="3">{{ $registro->antquirurgico_descripcion }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="alergia">
                                        ...
                                        <div class="row text-center">
                                            <div class="form-group col-md-10 offset-md-1">
                                                ...
                                                <textarea class="form-control form-control-sm" id="antalergia_descripcion" name="antalergia_descripcion" rows="3">{{ $registro->antalergia_descripcion }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="ginecologico">
                                        ...
                                        <div class="row text-center">
                                            <div class="form-group col-md-10 offset-md-1">
                                                ...
                                                <textarea class="form-control form-control-sm" id="antgineco_descripcion" name="antgineco_descripcion" rows="3">{{ $registro->antgineco_descripcion }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="familiar">
                                        ...
                                        <div class="row text-center">
                                            <div class="form-group col-md-10 offset-md-1">
                                                ...
                                                <textarea class="form-control form-control-sm" id="antfamiliar_descripcion" name="antfamiliar_descripcion" rows="3">{{ $registro->antfamiliar_descripcion }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="medicamento">
                                        ...
                                        <div class="row text-center">
                                            <div class="form-group col-md-10 offset-md-1">
                                                ...
                                                <textarea class="form-control form-control-sm" id="antmedicamento_descripcion" name="antmedicamento_descripcion" rows="3">{{ $registro->antmedicamento_descripcion }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="input-group input-group-sm col-md-5 offset-md-1  mb-1">
                                                                ...
                                                                <input type="number" class="form-control" id="tabaco_cnt" name="tabaco_cnt" value="{{ $registro->tabaco_cnt }}" style="text-align: right;">
                                                            </div>
                                                            <div class="input-group mb-1 input-group-sm col-md-5">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">Tiempo</span>
                                                                </div>
                                                                <input type="number" class="form-control" id="tabaco_tiempo" name="tabaco_tiempo" value="{{ $registro->tabaco_tiempo }}" style="text-align: right;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="input-group input-group-sm col-md-5 offset-md-1 mb-1">
                                                                ...
                                                                <input type="number" class="form-control" id="alcohol_cnt" name="alcohol_cnt" value="{{ $registro->alcohol_cnt }}" style="text-align: right;">
                                                            </div>
                                                            <div class="input-group mb-1 input-group-sm col-md-5">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">Tiempo</span>
                                                                </div>
                                                                <input type="text" class="form-control" id="alcohol_tiempo" name="alcohol_tiempo" value="{{ $registro->alcohol_cnt }}" style="text-align: right;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
