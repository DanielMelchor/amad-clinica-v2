                ...
                <div class="bg-default clearfix">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-2" style="text-align: right;">
                            <a href="{{ route('nueva_nc') }}" class="btn btn-xs btn-outline-primary rounded-circle elevation-4" title="Grabar"><i class="fas fa-plus-circle"></i></a>
                            ...
                            <tbody>
                                @foreach($listado as $l)
                                    <tr>
                                        ...
                                        <td style="text-align: right;">{{ number_format($l->precio_neto, 2, '.', ',') }}</td>
                                        <td style="text-align: right;">{{ number_format(0, 2, '.', ',') }}</td>
                                        <td>{{ $l->estado_descripcion }}</td>
                                        <td>
                                            @php $Id= Crypt::encrypt($l->id); @endphp;
                                            <a href="{{ route('editar_nc', [$Id]) }}" class="btn btn-xs btn-warning rounded-circle elevation-4" title="Editar documento">
