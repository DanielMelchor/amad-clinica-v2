...
@section('content')
    ...
    @php $observacionId= Crypt::encrypt($pObservacion->id); @endphp
	<form role="form" method="POST" action="{{route('actualizar_observacion', $observacionId)}}">
		@csrf
